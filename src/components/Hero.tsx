...
const Hero = () => {
  ...
  const handleAddField = () => {
    if (fieldName && cropType) {
      toast({
        title: "Field Added! 🌾",
        description: `"${fieldName}" with ${cropType} has been created. Sensors will sync shortly.`,
      });
      ...
      toast({
        ...
        description: "Both field name and crop type are required.",
        variant: "destructive",
      });
    }
  };
  ...
  const handleSeeDemo = () => {
    ...
    toast({
      ...
      description: "Scroll down to see our live dashboard demo!",
    });
  };
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12 animate-slide-up delay-200">
                <Button variant="hero" size="xl" onClick={() => setIsAddFieldOpen(true)}>
                  Add a Field
                  <ArrowRight className="w-5 h-5" />
                </Button>
                <Button variant="outline" size="xl" onClick={handleSeeDemo}>
              ...
              <div className="card-elevated p-6 lg:p-8 glow-primary">
                ...
                <div className="h-32 bg-gradient-to-r from-sky-light/50 to-leaf-light/50 rounded-xl flex items-end justify-around px-4 pb-4 mb-6">
                  {[65, 45, 70, 55, 80, 60, 75].map((height, i) => (
                    <div
                      key={i}
                      className="w-6 bg-primary/60 rounded-t-md transition-all hover:bg-primary cursor-pointer"
                      style={{ height: `${height}%` }}
                    />
                  ))}
                </div>
      ...
      <Dialog open={isAddFieldOpen} onOpenChange={setIsAddFieldOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Enter your field details to start monitoring soil and weather conditions.
            </DialogDescription>
          </DialogHeader>
